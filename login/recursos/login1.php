...
<body>
                                ...
                                <div class="container text-center">
                                    <form action="" method="POST" class="mt-3">
                                        ...
                                        <div id="2faField" style="display: none;">
                                            <input type="text" name="codigo2FA" class="form-control mt-2"
                                                placeholder="Ingrese el Codigo" required>
                                        </div>

                                        <!-- Checkbox para activar/desactivar 2FA -->
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" id="activar2FA"
                                                name="activar2FA">
                                            <label class="form-check-label" for="activar2FA">Activar 2FA</label>
                                        </div>
    ...
    ************************************************* -->
    <script>
        var checkboxActivar2FA = document.getElementById('activar2FA');
        var labelActivar2FA = document.querySelector('label[for="activar2FA"]');
        var field2FA = document.getElementById('2faField');

        checkboxActivar2FA.addEventListener('change', function () {
            if (this.checked) {
                field2FA.style.display = "block";
                labelActivar2FA.textContent = 'Desactivar 2FA';
            } else {
                field2FA.style.display = "none";
                labelActivar2FA.textContent = 'Activar 2FA';
            }
        });
    </script>
